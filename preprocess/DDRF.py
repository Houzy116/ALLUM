...
if __name__=='__main__':
    ...
    f_white_data[f_white_mask==1]=2
    ds=[trf_lon(resample(f_white_data[i])) for i in range(240)]
    ...
    fn_white_data[fn_white_mask==1]=2
    ds=[trf_lon(resample(fn_white_data[i])) for i in range(240)]
    ...
    fv_white_data[fv_white_mask==1]=2
    ds=[trf_lon(resample(fv_white_data[i])) for i in range(240)]
